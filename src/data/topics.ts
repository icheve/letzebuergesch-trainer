...
const word = (id: string, luxembourgish: string, russian: string): VocabularyCard => ({
  id,
  luxembourgish,
  russian,
})
...
const homeland: Topic = {
  ...
  icon: 'home',
  vocabulary: [
    word('homeland-heemecht', 'd’Heemecht', 'родина'),
    word('homeland-haaptstad', 'd’Haaptstad', 'столица'),
    word('homeland-awunner', 'den Awunner', 'житель'),
    word('homeland-tourist', 'den Tourist', 'турист'),
    word('homeland-attraktioun', 'd’Touristenattraktioun', 'туристическая достопримечательность'),
    word('homeland-regioun', 'd’Regioun', 'регион'),
    word('homeland-traditioun', 'd’Traditioun', 'традиция'),
    word('homeland-nationalfeierdag', 'de Nationalfeierdag', 'национальный праздник'),
    word('homeland-spezialiteit', 'd’Spezialitéit', 'традиционное блюдо; специалитет'),
    word('homeland-plage', 'd’Plage', 'пляж'),
    word('homeland-sei', 'de Séi', 'озеро'),
    word('homeland-secher', 'sécher', 'безопасный'),
    word('homeland-besichen', 'besichen', 'посещать'),
  ],
  sentences: [
...
const languages: Topic = {
  ...
  icon: 'languages',
  vocabulary: [
    word('languages-sprooch', 'd’Sprooch', 'язык'),
    word('languages-mammesprooch', 'd’Mammesprooch', 'родной язык'),
    word('languages-friemsprooch', 'd’Friemsprooch', 'иностранный язык'),
    word('languages-schwatzen', 'schwätzen', 'говорить'),
    word('languages-leieren', 'léieren', 'учить; изучать'),
    word('languages-aussprooch', 'd’Aussprooch', 'произношение'),
    word('languages-grammatik', 'd’Grammatik', 'грамматика'),
    word('languages-vocabulaire', 'de Vocabulaire', 'словарный запас'),
    word('languages-liesen', 'liesen', 'читать'),
    word('languages-lauschteren', 'lauschteren', 'слушать'),
    word('languages-schreiwen', 'schreiwen', 'писать'),
    word('languages-verstoen', 'verstoen', 'понимать'),
    word('languages-kommunizeieren', 'kommunizéieren', 'общаться'),
    word('languages-ueben', 'üben', 'упражняться; практиковаться'),
  ],
  sentences: [
...
const housing: Topic = {
  ...
  icon: 'housing',
  vocabulary: [
    word('housing-wunneng', 'd’Wunneng', 'квартира'),
    word('housing-haus', 'd’Haus', 'дом'),
    word('housing-quartier', 'de Quartier', 'район'),
    word('housing-strooss', 'd’Strooss', 'улица'),
    word('housing-stuff', 'd’Stuff', 'гостиная'),
    word('housing-schlofkummer', 'd’Schlofkummer', 'спальня'),
    word('housing-terrass', 'd’Terrass', 'терраса'),
    word('housing-gaart', 'de Gaart', 'сад'),
    word('housing-garage', 'd’Garage', 'гараж'),
    word('housing-secher', 'sécher', 'безопасный'),
    word('housing-roueg', 'roueg', 'тихий; спокойный'),
    word('housing-praktesch', 'praktesch', 'практичный; удобный'),
  ],
  sentences: [
